        ...
        <div style={{ marginTop: '120px', backgroundColor: '#8533ff' }}>
            {
                spiceData.map((spiceItem, index) => {
                    let imageContainer = images(`./${spiceItem.imageContainer}`)
                    let imageSpice = images(`./${spiceItem.imageSpice}`)
                    return (
                        <Container fluid='xl'>
                            <Row>
                                <Col className='col-1' />
                                <Col className='col-10'>
                                    <Card style={{ width: '100%', marginTop: '10%', backgroundColor: '#cc0000' }}>
                                        ...
                                        <Row>
                                            <Col className='col-1' />
                                            <Col className='col-4'>
                                                <Image src={imageContainer} width='100%' rounded alt={'source doesnt exist'} />
                                            </Col>
                                            <Col className='col-1' />
                                            <Col className='col-4'>
